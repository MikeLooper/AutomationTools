...
Detailed unit test creation and maintenance rules are defined in `.github/instructions/unit-tests-[language]/unit-tests.instructions.md`.

For `[language]` in the above path, a programming laguage wouould be submitted, such as `python`.
